...
| `LutLoader` | class | Load VLUT; 1D/2D/3D linear sampling; First-In Vector axis-name hash (FNV-1a) lookup. `engine/formula/lut_loader.h:38` |
...
- Khronos Group. *glslang — reference GLSL/ESSL front-end + AST* (April 2026 release notes — HLSL front-end deprecated, signalling industry move to single-AST codegen pipelines). <https://github.com/KhronosGroup/glslang>
- Loose, Z. *LoR-LUT: Learning Compact 3D Lookup Tables via Low-Rank Residuals* (2026 preprint) — current research direction for LUT compression. <https://arxiv.org/html/2602.22607>
