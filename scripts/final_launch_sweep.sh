...
echo "  - Tag pre-release on Vestige (engine-only; VestigeAssets stays private until ~v1.0.0)"
echo "  - Flip Vestige private→public in GitHub Settings"
echo "  - Verify fresh clone on a clean machine (default VESTIGE_FETCH_ASSETS=OFF path)"
