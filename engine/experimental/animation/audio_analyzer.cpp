...
// π as a portable constant. <cmath>'s M_PI is not standard C++ and is absent
// on MSVC unless _USE_MATH_DEFINES is set before the (possibly transitive)
// <cmath> include; a local constexpr avoids that fragility (C++17, no std::numbers).
