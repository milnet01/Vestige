    ...
    return {
        ...
        "security": [
            ...
            {"name": "unsafe_deserialization",
             ...
             "file_glob": "*.cpp", "severity": "high",
             "description": "Loading untrusted code — verify input validation / sandbox (CWE-502)",
             "skip_comments": True},
